     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td><input type="text" id="freight"  name="freight" value="<?php echo ($set["freight"]); ?>" class="px" style="width:100px;" /> 元</td> 
       </tr>
        <tr> 
        ...
        <TR>
				  ...
				  <td><script id="editor" name="intro" type="text/plain" style="width:590px;height:360px;"><?php echo ($set["intro"]); ?></script></td>
                </TR>  
       <tr>         
       <th>&nbsp;</th>
       <td>
