...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
            <a href="<?php echo U('Qrcode/index',array('token'=>$token));?>" >
                <img src="<?php echo RES;?>/images/CRM.jpg" />
            </a>
            <div id="TwoMenu-08" <?php if(in_array(MODULE_NAME,array('Qrcode','Group'))){ ?>style="display:block;" <?php }else{ ?>style="display:none;"<?php } ?> >
...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
            <div class="contab" <?php if(in_array(MODULE_NAME,array('Qrcode','Group'))){ ?>style="display:block;" <?php }else{ ?>style="display:none;"<?php } ?> >
				<a href="<?php echo U('Qrcode/index',array('token'=>$token));?>"  class="Red"  >
                    <img src="<?php echo RES;?>/images/Qr01.jpg" /><span>渠道二维码</span><span class="introduction">带参数渠道二维码</span>
                </a>
				<a href="<?php echo U('Group/index',array('token'=>$token));?>"  class="Red"  >
...
<?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
	...
	<div class="control-group">
		...
		<div class="controls">
      <img class="thumb_img" id="cover_src" src="<?php echo (($es_data['cover'])?($es_data['cover']):'/weiqiyedata/sucai/estate/1.jpg'); ?>" style="max-height:100px;">
      	<input type="text" name="cover" value="<?php echo (($es_data['cover'])?($es_data['cover']):'/weiqiyedata/sucai/estate/1.jpg'); ?>" id="cover" class="px" style="width:150px;"  readonly="readonly"/><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('cover',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
	...
	<div class="control-group">
         <label class="control-label">楼盘头部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="banner_src" src="<?php echo (($es_data['banner'])?($es_data['banner']):'/weiqiyedata/sucai/estate/2.png'); ?>" style="max-height:100px;"> 
                                            <input type="text" id="banner" name="banner" class="px" value="<?php echo (($es_data['banner'])?($es_data['banner']):'/weiqiyedata/sucai/estate/2.png'); ?>"> 
	...
	<div class="control-group">
		<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'/weiqiyedata/sucai/estate/4.png'); ?>" style="max-height:100px;">
                                        <input type="text" name="house_banner" id="house_banner" class="px" value="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'/weiqiyedata/sucai/estate/4.png'); ?>">
                                        <span class="help-inline">
