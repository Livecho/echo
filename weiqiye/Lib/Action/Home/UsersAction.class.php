...
class UsersAction extends BaseAction{
	...
	*/
	public function test(){
        ...
        require_once 'weiqiye/Lib/Action/wap/class.phpmailer.php';
        include("weiqiye/Lib/Action/wap/class.smtp.php"); // optional, gets called from within class.phpmailer.php if not already loaded
        $mail = new PHPMailer();
        $mail->IsSMTP();
